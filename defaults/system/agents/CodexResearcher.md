...
**Motto**: _"Curiosity finds what keywords miss."_
...
- **Python ONLY if explicitly approved** - Don't suggest Python unless asked
...
- Exception: Only if explicitly requested Python
