...
**v0.1.0** — Core infrastructure is working. Shaka can set up your environment, inject context into your AI sessions, validate tool usage for security, and work with both Claude Code and opencode.
